...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen z-90 text-white font-sans relative ">
      ...
      {/* <section className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
        <h1
          ref={text1}
          className="font-light tracking-tighter 
                     text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl"
        >
          Always <span className="text-red-600 font-extrabold">Solving</span>
        </h1>
        <h1
          ref={text2}
          className="tracking-tighter 
                     text-5xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10vw]"
        >
          Always <span className="text-white font-extrabold">Evolving</span>
        </h1>
      </section>    */}
    </div>
  )
