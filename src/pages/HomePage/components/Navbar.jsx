          ...
          children: [
            {
              label: "Green Mowers",
              children: [
                { label: "Toro Greenmaster 1021", href: "https://www.toro.com/en/product/04830" },
  ...
  children: [
    {
      ...
      href: "https://www.toro.com/en/product/38756",
    },
    {
      ...
      children: [
        {
          ...
          href: "https://www.paraide.com/products/tee-area/markers/cast-aluminum-low-profile-tee-marker/"
          ...
          href: "https://www.paraide.com/products/tee-area/markers/individual-replacement-bands/"
          ...
          href: "https://www.paraide.com/products/green-area/regulation-flags/solid-flags-400-denier/"
      ...
      children: [
        {
          ...
          children: [
            { label: "Routine checkup & Maintainance", href: "#paraide-a1" },
            { label: "Customized AMC plan", href: "#paraide-a2" },
          ],
        },
        {
          label: "Spare parts",
          children: [
            { label: "Toro parts & Operator manuals", href: "#paraide-b1" },
            { label: "Toro performance parts catalouge", href: "#paraide-b2" },
            { label: "Toro Tine Charts", href: "#paraide-b2" },
            { label: "Allied Equipments parts catalouge", href: "#paraide-b2" },
          ],
        },
      ],
    },
    ...
    return (
      <div key={key} className="px-3 h-fit py-1">
        {item.children ? (
          <>
            <button
              onClick={() => toggleNested(labelPath)}
              className={`flex items-center h-fit justify-between relative z-50 w-full text-left ${
                level === 0 ? "text-gray-300" : level === 1 ? "text-gray-400" : "text-gray-500"
            ...
            >
              {/* use inline style for margin-left instead of dynamic Tailwind class */}
              <div
          ...
          <a
            href={item.href}
            className={`block ${level === 2 ? "text-gray-400" : "text-gray-300"} hover:text-white transition text-sm py-1`}
          >
            {item.label}
          </a>
        )}
    ...
    <div className="text-white font-[font5]">
      ...
      <header className="px-6 md:px-10 mx-auto flex justify-between bg-black/70 items-center py-4 backdrop-blur-sm shadow-md sticky top-0 z-50">
        <div className="text-5xl font-bold uppercase">
          <a href="/" className="  text-[#E5942D] font-[font1]">Surge <span className="text-[#76736C]"> System</span> </a>
        </div>
