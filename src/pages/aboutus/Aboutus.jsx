      ...
      <div className='flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-16 gap-12'>
        ...
        <div className='w-full lg:w-1/2 text-left'>
          ...
          <p className='text-gray-300 leading-relaxed'>
            o Sales & Service of Turf Maintenance Equipment. <br />
            o Design, Supply, Installation, Testing & Commissioning of Pop-up Sprinkler...
          </p>
          <img ref={image2Ref} src='about/2.jpg' alt='Golf Shoes' className='mt-8 w-full max-w-sm rounded-xl object-cover' />
        </div>
      </div>

      <div className='fixed bottom-6 z-2 right-6 w-28 h-28 rounded-full bg-white flex items-center justify-center overflow-hidden'>
          ...
          <svg viewBox='0 0 100 100' className='w-full h-full'>
            ...
            <text fill='black' fontSize='10' fontWeight='bold'>
              <textPath href='#circlePath' startOffset='0'>
                PROFESSIONAL GOLF CLUB • PROFESSIONAL GOLF CLUB •
              </textPath>
            </text>
          </svg>
        </div>
