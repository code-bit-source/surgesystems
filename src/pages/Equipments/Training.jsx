...
export const trainingData = [
  {
    ...
    img: "https://www.ball-launcher.com/images/modules/promo_units/medium/1640424338-25568800.png",
  },
  {
...
<div className="fixed top-0 left-0 w-full h-full -z-10">
  <img
    src="https://plus.unsplash.com/premium_photo-1661369229335-1236f5288edd?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1169"
    alt=""
      ...
      <div className="px-10 py-20 md:px-20">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 mt-3">
            Explore all Training equipment categories below.
          </p>
        </div>
